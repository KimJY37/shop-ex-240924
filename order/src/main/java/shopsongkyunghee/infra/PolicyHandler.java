...
import shopsongkyunghee.config.kafka.KafkaProcessor;
...
public class PolicyHandler {
    ...
    public void wheneverStockIncreased_NotifyToWating(
        @Payload StockIncreased stockIncreased
    ) {
        StockIncreased event = stockIncreased;
        System.out.println(
            "\n\n##### listener NotifyToWating : " + stockIncreased + "\n\n"
        );

        // Sample Logic //
        Order.notifyToWating(event);
    }
